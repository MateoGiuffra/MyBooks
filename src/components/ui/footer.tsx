...
const footer = () => {
    return (
        <footer className="w-full fixed bottom-0 border-t border-gray-400 bg-footer z-9999">
            <div className="w-full pt-8 pb-8 flex flex-row justify-between">
                <div className="flex flex-col items-center flex-1 ">
                    <Link href="/" className="flex items-center flex-col justify-center gap-1">
                        <LibrarySquareIcon width={28} height={28} className='text-footer' />
                    </Link>
                </div>
                <div className="flex flex-col items-center flex-1">
                    <Link href="/add-book" className="flex items-center justify-center flex-col gap-0.5">
                        <SearchIcon width={28} height={28} className='text-footer' />
                    </Link>
                </div>
                <div className="flex flex-col items-center flex-1">
